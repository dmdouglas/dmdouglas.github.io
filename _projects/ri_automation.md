...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/testalize-me-igSTmAWAW3s-unsplash.jpg" title="Automated process where samples are being analysed from transport tubes in a large Dutch lab" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
