...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/markus-spiske-KeFyYzxqmH0-unsplash.jpg" title="A closeup of a computer screen with a lot of text on it" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
I published two papers based on thesis chapters. 'A Bundle of Software Rights and Duties' presented the framework of property rights and duties that describes the various ways software may be used by three types of stakeholders: users, developers, and custodians. 'The Social Distuility of Software Ownership' is based on the thesis chapter that examines the arguments against software ownership based on the social costs of withholding rights from users.
